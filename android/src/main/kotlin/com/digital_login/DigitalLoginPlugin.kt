...
class DigitalLoginPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    private lateinit var channel: MethodChannel
    private lateinit var scheme: String
    private var activity: Activity? = null

    companion object {
        const val CHANNEL = "digital_login"
    }
    ...
    private fun performLogin(url: String, clientId: String, redirectUri: String, scope: String, sessionId: String, responseType: String) {
        val intent = Intent(Intent.ACTION_VIEW).apply {
            data = Uri.parse(getDigitalUrl(url, clientId, redirectUri, scope, sessionId, responseType))
        }
        activity?.startActivity(intent)
    }

    private fun getDigitalUrl(url: String, clientId: String, redirectUri: String, scope: String, sessionId: String, responseType: String): String {
